...
def email(subject: str, body: str, to: str, attachments: list[PDF_OBJ] = None):
    '''
    ...
    '''
    msg = EmailMessage()
    mail = config.SEND_GRID_EMAIL
    password = config.SEND_GRID_API_KEY
    msg['From'] = mail
    msg['To'] = to
    msg['Subject'] = subject
...
def email_self(subject: str, body: str, attachments: list[PDF_OBJ] = None) -> None:
    ...
    Example:
        ...
        ... )
    """
    email(to=config.GOOGLE_EMAIL, subject=subject, body=body, attachments=attachments)